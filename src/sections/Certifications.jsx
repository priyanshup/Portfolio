...
const CertCard = ({ c }) => {
  ...
  const cls = "p-6 rounded-2xl bg-cardBg border dark:border-gray-800 border-slate-200 text-center dark:hover:border-gray-600 hover:border-slate-300 transition-colors flex flex-col items-center group h-full";
